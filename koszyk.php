            ...
            <div class="section group">
                ...
                <p class="sectionTitle">Koszyk:<p>
                        ...
                        <div class="col span_3_of_12">
                            <p class="sectionTextBold textMenu">Nazwa produktu</p>
                        </div>
                        <div class="col span_2_of_12">
                            <p class="sectionTextBold textMenu">Ilość</p>
                        </div>
                        <div class="col span_3_of_12">
                            <p class="sectionTextBold textMenu">Cena za produkt</p>
                        </div>
                        <div class="col span_3_of_12">
                            <p class="sectionTextBold textMenu">Cena za produkty</p>
                        </div>
            ...
            <div class="section group">
                ...
                if (!empty($_SESSION["cart"])) {
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
                        ...
                        <div class="col span_1_of_12"></div>
                        <div class="col span_3_of_12">
                            <p class="textMenu"><?php echo $value["item_name"];
                                                $outall = '' . $outall . $value["item_name"] . '/'; ?></p>
                        </div>
                        <div class="col span_2_of_12">
                            <p class="textMenu"><?php echo $value["item_quantity"]; ?></p>
                        </div>
                        <div class="col span_3_of_12">
                            <p class="textMenu"><?php echo $value["product_price"]; ?> zł</p>
                        </div>
                        <div class="col span_3_of_12">
                            <p class="textMenu"><?php echo number_format($value["item_quantity"] * $value["product_price"], 2); ?> zł</p>
                        </div>
    ...
    <section>
        ...
        <section>
            ...
            <div class="section group">
                ...
                <div id="przycisk_zamow" onclick="document.getElementById('okno_potwierdzajace').style.display='block'">
                    <p class="sectionTextBold textMenu">Złóż zamówienie</p>
                </div>

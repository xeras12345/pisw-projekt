...
<body>
    ...
    <div id="napisprzed" class="section group">
        ...
        <div class="col span_4_of_12">
            <h2>Aby złożyć zamówienie musisz być zalogowany</h2>
        </div>
    ...
    <div class="section group">
        ...
        <div class="col span_3_of_12">
            <div class="niezalogowanyloguj" onclick="document.getElementById('modal-wrapper').style.display='block'"><input type="submit" value="Zaloguj się"></div>
        </div>
        <div class="col span_4_of_12"></div>
    </div>

...
<body>
    ...
    <section>
        ...
        <div class="section group">
            <div class="col span_12_of_12">
                <a>
                    <p id="dodajpozycje" class="sectionTextBold textMenu" onclick='submitForm2("przystawki")'>Dodaj nową pozycję</p>
                </a>
            </div>
        </div>
    </section>
    ...
    <section>
        ...
        <div class="section group">
            <div class="col span_12_of_12">
                <a>
                    <p id="dodajpozycje" class="sectionTextBold textMenu" onclick='submitForm2("zupy")'>Dodaj nową pozycję</p>
                </a>
            </div>
        </div>
    </section>
    ...
    <section>
        ...
        <div class="section group">
            <div class="col span_12_of_12">
                <a>
                    <p id="dodajpozycje" class="sectionTextBold textMenu" onclick='submitForm2("dania")'>Dodaj nową pozycję</p>
                </a>
            </div>
        </div>
    </section>
